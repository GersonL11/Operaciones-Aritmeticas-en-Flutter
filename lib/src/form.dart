          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Container(
                width: 180,
                height: 40,
                margin: EdgeInsets.only(left: 100), // Alineado a la derecha
                decoration: BoxDecoration(
                  border: Border.all(color: Colors.black),
                  borderRadius: BorderRadius.circular(8),
                  color: Colors.purple[200], // Cambié el color a morado claro como solicitado
                ),
                child: Center(
                  child: DropdownButton<String>(
                    ...
                    style: TextStyle(color: Colors.black), // Cambié el color del texto a negro
                    dropdownColor: Colors.purple[200], // Aplicado el mismo color morado claro al fondo de la lista de operaciones
                  ),
                ),
              ),
              SizedBox(height: 40),
